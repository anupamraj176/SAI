...
import { Send, HelpCircle, ChevronDown, ChevronUp, Mail, MessageSquare, User } from "lucide-react";
    ...
    return (
        <div className="border border-[#FFD9A0] rounded-lg bg-white overflow-hidden mb-3 shadow-sm">
            ...
            >
                ...
                {isOpen ? <ChevronUp className="text-[#FF8C42]" /> : <ChevronDown className="text-[#FF8C42]" />}
            </button>
            {isOpen && (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label className="block text-sm font-medium text-[#8C2F2B] mb-1">Your Name</label>
                            <div className="relative">
                                <User className="absolute left-3 top-2.5 text-[#FFD9A0]" size={18} />
                                <input
                                    type="text"
                                    value={formData.name}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-[#8C2F2B] mb-1">Email Address</label>
                            <div className="relative">
                                <Mail className="absolute left-3 top-2.5 text-[#FFD9A0]" size={18} />
                                <input
                                    type="email"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-[#8C2F2B] mb-1">Subject</label>
                            <div className="relative">
                                <MessageSquare className="absolute left-3 top-2.5 text-[#FFD9A0]" size={18} />
                                <select
                        ...
                        <div>
                            <label className="block text-sm font-medium text-[#8C2F2B] mb-1">Message</label>
                            <textarea
                ...
                <motion.div 
                    ...
                    animate={{ opacity: 1, x: 0 }}
                >
                    <h2 className="text-xl font-bold text-[#C24C30] mb-6">Frequently Asked Questions</h2>
