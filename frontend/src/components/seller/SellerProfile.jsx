    ...
    return (
        <div className="max-w-5xl mx-auto pb-10">
            ...
            <div className="relative h-48 md:h-64 rounded-3xl overflow-hidden shadow-lg mb-16">
                <div className="absolute inset-0 bg-gradient-to-r from-[#1F3326] to-[#347B66]"></div>
            ...
            <div className="relative px-4 md:px-8 -mt-24">
                <div className="bg-[#E8F5E9] rounded-3xl shadow-xl border border-[#6FA99F] overflow-visible">
                    
                    {/* PROFILE IMAGE (Floating) */}
                    <div className="absolute -top-16 left-1/2 -translate-x-1/2 md:left-12 md:translate-x-0">
                        <div className="relative group">
                            <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-[#E8F5E9] shadow-lg bg-[#C8E6C9]">
                                {image ? (
                                    <img src={image} alt="Profile" className="w-full h-full object-cover" />
                                ) : (
                                    <div className="w-full h-full flex items-center justify-center text-[#347B66] bg-[#C8E6C9]">
                                        <Camera size={48} />
                                    </div>
                                )}
                            </div>
                            <label className="absolute bottom-2 right-2 bg-[#347B66] text-white p-2.5 rounded-full cursor-pointer hover:bg-[#1F3326] transition shadow-md border-2 border-[#E8F5E9]">
                                <Upload size={18} />
                    ...
                    <div className="pt-20 md:pt-28 pb-8 px-6 md:px-10">
                        ...
                        <div className="md:hidden text-center mb-8">
                            <h1 className="text-2xl font-bold text-[#1F3326]">{name || "Farm Name"}</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            {/* SECTION: BASIC INFO */}
                            <div>
                                <h3 className="text-lg font-bold text-[#1F3326] mb-4 flex items-center gap-2 border-b border-[#6FA99F] pb-2">
                                    <FileText size={20} /> Basic Information
                                </h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {/* Name */}
                                    <div>
                                        <label className="block text-sm font-bold text-[#1F3326] mb-2">
                                            Farm / Seller Name
                                        </label>
                                        <input
                                            type="text"
                                            ...
                                            className="w-full px-4 py-3 rounded-xl border border-[#6FA99F] bg-[#C8E6C9]
                                                    focus:ring-2 focus:ring-[#347B66] focus:border-transparent outline-none transition text-[#1F3326]"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Mail className="absolute left-4 top-3.5 text-[#347B66]" size={18} />
                                            <input
                                                type="email"
                                                value={user?.email}
                                                readOnly
                                                className="w-full pl-12 pr-4 py-3 rounded-xl border border-[#6FA99F] bg-[#6FA99F]/30
                                                        text-[#1F3326] cursor-not-allowed font-medium"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Phone className="absolute left-4 top-3.5 text-[#347B66]" size={18} />
                                            <input
                                                type="tel"
                                                value={phoneNumber}
                                                onChange={(e) => setPhoneNumber(e.target.value)}
                                                placeholder="+91 98765 43210"
                                                className="w-full pl-12 pr-4 py-3 rounded-xl border border-[#6FA99F] bg-[#C8E6C9]
                                                        focus:ring-2 focus:ring-[#347B66] focus:border-transparent outline-none transition text-[#1F3326]"
                                            />
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 rounded-xl border border-[#6FA99F] bg-[#C8E6C9]
                                            focus:ring-2 focus:ring-[#347B66] focus:border-transparent outline-none transition text-[#1F3326] resize-none"
                                />
                            </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-3 px-4 rounded-xl border border-dashed border-[#347B66] 
                                                flex items-center justify-center gap-2 font-semibold transition
                                                ${location ? "bg-[#347B66]/10 text-[#347B66]" : "bg-[#C8E6C9] text-[#1F3326] hover:bg-[#347B66]/5"}`}
                                        >
                                            {location ? (
                                                <>
                            ...
                            {/* SUBMIT BUTTON */}
                            <div className="pt-6 border-t border-[#6FA99F] flex justify-end">
                                <button
                                    type="submit"
                                    disabled={isLoading || uploading}
                                    className="w-full md:w-auto px-10 py-4 bg-gradient-to-r from-[#1F3326] to-[#347B66] text-white rounded-xl font-bold 
            ...
            {isMapOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh]">
                        <div className="p-4 border-b flex justify-between items-center bg-[#C8E6C9]">
                            <h3 className="font-bold text-lg text-[#1F3326]">Select Farm Location</h3>
                        ...
                        <div className="p-4 border-t bg-[#C8E6C9] flex justify-end">
                            <button 
                                onClick={() => setIsMapOpen(false)}
                                className="px-6 py-2 bg-[#347B66] text-white rounded-lg font-bold hover:bg-[#1F3326] transition"
                            >
                                Confirm Location
                            </button>
                        </div>
